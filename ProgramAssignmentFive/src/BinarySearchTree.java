//Received help from the computer lab on the methods.
/**
 * Nate Bowers
 * Dr. H  MW 1PM Class
 * 11/6/2015
...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public int getNumberOfLeaves() {
        ...
        int sum = 0;
        if (current != null){
            sum = getNumberOfLeaves(sum, current);
        }//if
        return sum;
    }//getNumberOfLeaves

    private int getNumberOfLeaves(int sum, TreeNode<E> current){
        if (current.left == null && current.right == null){
            sum++;
        }//if
        else {
            if (current.left != null){
                sum = getNumberOfLeaves(sum, current.left);
            }//if
            if (current.right != null){
                sum = getNumberOfLeaves(sum, current.right);
            }//if
        }//else
        return sum;
    }//private getNumberOf Leaves

      public TreeNode<E> helperNode(E e){
        TreeNode<E> current = root; 
    ...
    public ArrayList<E> leftSubTree(E e){
        return leftSubTree(root.left);
    }//leftSubTree

    public ArrayList<E> rightSubTree(E e){
        return rightSubTree(root.right);
    }//rightSubTree

    /* Returns an ArrayList containing all elements in preorder of the specified element’s left sub-tree, returns an empty 
ArrayList if no  such element exists. */
    private ArrayList<E> leftSubTree(TreeNode<E> root) {
    ...
    /* Returns an ArrayList containing all elements in preorder of the specified element’s right sub-tree, returns an 
empty ArrayList if no  such element exists. */

    private ArrayList<E> rightSubTree(TreeNode<E> root) {
        ArrayList<E> list = new ArrayList<E>();
        if (root == null) {
            return list;
        }//if
